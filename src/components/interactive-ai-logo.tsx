...
export const InteractiveAiLogo = () => {
  // Removing click-based blast animation for a minimal design
  const circuitPieces = [
    ...
    <div className="interactive-logo-container">
      <svg viewBox="0 0 400 400" className="interactive-logo">
        <g className="logo-geometry">
           {/* Inner square */}
          <rect x="120" y="120" width="160" height="160" rx="10" fill="hsl(var(--background))" stroke="hsl(var(--primary))" strokeWidth="4" className={'circuit-path logo-inner-chip'} style={{animationDelay: '0.2s'}} />
