  ...
  return (
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <Card className="bg-card border border-primary/20 hover:border-primary transition-all duration-300 hover:shadow-[0_0_15px_hsl(var(--primary)/0.5)]">
          <CardHeader>
              <CardTitle className="text-xl font-bold text-primary neon-glow flex items-center gap-2"><Wand2 /> AI Summarizer</CardTitle>
              <CardDescription className="text-base text-muted-foreground">Generate concise summaries from your notes instantly.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-card border border-primary/20 hover:border-primary transition-all duration-300 hover:shadow-[0_0_15px_hsl(var(--primary)/0.5)]">
          <CardHeader>
              <CardTitle className="text-xl font-bold text-primary neon-glow flex items-center gap-2"><BrainCircuit /> AI Flashcards</CardTitle>
              <CardDescription className="text-base text-muted-foreground">Turn your notes into interactive flashcards for effective learning.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-card border border-primary/20 hover:border-primary transition-all duration-300 hover:shadow-[0_0_15px_hsl(var(--primary)/0.5)]">
          <CardHeader>
              <CardTitle className="text-xl font-bold text-primary neon-glow flex items-center gap-2"><TestTube2 /> AI Quiz Generator</CardTitle>
              <CardDescription className="text-base text-muted-foreground">Test your knowledge with auto-generated quizzes.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-card border border-primary/20 hover:border-primary transition-all duration-300 hover:shadow-[0_0_15px_hsl(var(--primary)/0.5)]">
          <CardHeader>
              <CardTitle className="text-xl font-bold text-primary neon-glow flex items-center gap-2"><Sparkles /> AI Tutor Chat</CardTitle>
              <CardDescription className="text-base text-muted-foreground">Your personal AI tutor, ready to answer your questions.</CardDescription>
          </CardHeader>
          <CardContent>
            <TutorChat notes={notes} onGenerate={checkAuth} />
          </CardContent>
